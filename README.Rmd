...
An HTML Document with an interactive map is shown [here](https://spacerome.github.io/STAT-184/project.html).
...
Below is the on time performance for the entire subway system.
