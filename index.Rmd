...
# Uncomment and use set_api_key() on terminal. Use this key b742b4e5-f67d-4eac-9c90-770c2a5bc5f5
feedlist_df <- get_feedlist() %>%
  filter(grepl('NYC Subway GTFS', t, ignore.case= TRUE))
NYC <- import_gtfs(feedlist_df$url_d)
routes <- NYC[['routes_df']] %>%
  slice(which(grepl('1|2|3|4|5|6|7|a|b|c|d|e|f|n|r|w', route_id, ignore.case=TRUE))) %>%
  '$'('route_id')
